...
export default class LostsGrid extends React.Component {
  ...
  render() {
    ...
    var elems = [{imgsrc: 'http://is12.snstatic.fi/img/978/1442189230387.jpg', name:'joku heepo'},
      ...
      {imgsrc: 'http://is12.snstatic.fi/img/978/1442189230387.jpg', name:'Nela Saganoova'},
    ...
    var items = elems.map(item => {
      return ( <div className="col-md-2"><a href="#" className="thumbnail"><img className="image-thumbnail" src={item.imgsrc}/><div className="caption"><h4>{item.name}</h4></div></a>  </div>)
    });
